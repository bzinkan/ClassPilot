...
This protocol was introduced in extension version 2.8.9 and is carried unchanged into the 2.9.0 candidate, which has not been uploaded or published to the Chrome Web Store. SchoolPilot API/web deployment does not distribute this extension. Follow the [2.9.0 release instructions](CLASSPILOT_2_9_0_RELEASE.md), including live-version verification, during the authorized extension release; the [2.8.9 release instructions](CLASSPILOT_2_8_9_RELEASE.md) remain the record for that version.
