...
For the prepared 2.9.2 Class tools candidate, the canonical artifact name will be
`dist/ClassPilot-v2.9.2.zip` after separately authorized clean-tag packaging.
