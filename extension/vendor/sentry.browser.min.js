(() => {
  ...
  async function sendEvent(event) {
    ...
    try {
      ...
      // Do not expose transport errors: browser implementations may attach the
      // DSN URL or request details to the exception object.
      console.warn('[Sentry] Failed to send event');
    }
  }
